       ...
       ?>		
       		<tr>
        		...
        		<td class="center" width="12%">
        			<a href="seller_product?id=<?php echo $result_array['seller_id']; ?>&role=<?php echo $result_array['role']; ?>" class="btn btn-success btn-sm"  data-toggle="tooltip" title="VIEW"><i class="glyphicon glyphicon-zoom-in icon-white"></i></a>
